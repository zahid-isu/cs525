...
double inverse_power_iteration(const matrix* A, const int max_iter, const double
tol, const double mu);
double rayleigh_quotient_iteration(const matrix* A, const int max_iter, const
double tol);
#endif