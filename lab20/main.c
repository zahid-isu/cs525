...
// The below code performs adaptive quadrature on the function f(x) = exp(-beta*x^2) + sin(x) on the interval [-2,4] using OpenMP.
// The objective is to compare the performance for different number of threads and different tolerance levels.
...
int main(int argc , char* argv [])
{
    ...
    char filename [36] = "quadrature4.data";
